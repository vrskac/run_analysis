...
### run_analysis.R
* When calling the run_analysis function three parameters can be supplied, all of which are logical and default to FALSE.
...
```
* If return\_tidy\_data is TRUE, then read the tidy data from CSV and return it to the function caller as a dplyr tbl_df.
```{r eval=FALSE}
if(return_tidy_data) {
...
## Output
* dplyr tbl_df, with 180 observations and 68 variables.
