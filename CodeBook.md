...
The following call to the **run\_analysis** function will re-prepare and re-tidy the data before returning it.
...
-   dplyr tbl\_df, with 180 observations and 68 variables.
...
|----------|---------|---------------------------------------------------------------------------------------------------------------------------------------|
| subject  | integer | The subject identifier from 1 to 30.                                                                                                  |
...
| 3:68     | numeric | See description of numeric measurement variables below.                                                                               |

#### Description of numeric measurement variables (columns 3 to 68)

-   An "\_" character is used to split the variable name for ease of understanding and readability.
-   The first part (always the first 4 characters) indicates if the measurement is for the time ("time") or frequency ("freq") domain.
-   The second part (after the first underscore) is the main label used to identify the measurement being taken.
-   The third part (after the second underscore) is the measurement function, either mean ("mean") or standard deviation ("std").
-   Some variables have a 4th part (after a third underscore) that indicates the axis of the measurement, either "x", "y" or "z".
