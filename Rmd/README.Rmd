...
library('knitr')
dir <- do.call(file.path, as.list(unlist(strsplit(getwd(), .Platform$file.sep))[1:length(unlist(strsplit(getwd(), .Platform$file.sep)))-1]))
...
```
```{r, include=FALSE}
file.copy(from = "Rmd/README.html", to = "README.md")
```